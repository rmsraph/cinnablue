...
# Name: cinablue
#
# IMPORTANT: If you fork this repository, change "cinablue" above to your desired project name.
...
# Base Image - Bluefin (recommended: includes Bluefin Developer Experience)
